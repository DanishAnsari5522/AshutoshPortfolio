                                ...
                                <div className="col-md-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex justify-content-center flex-column">
                                    <div className="p-absolute ml-0">
                                        <div className="contact-us">
                                            ...
                                            <div className="call"><BiPhoneCall className="call-icon" />Call Me  (+91) 1111111111</div>
                                            <div className="email"><HiOutlineMail className="call-icon" />Email abc123@gmail.com</div>
                                            <div>
                                                <div className="find-me-on">Follow Me</div>
                                                <div>
                                                    <a href="#" target="_blank" className="ds"><FaFacebookF className="socalmedia-icon" /></a>
                                                    <a href="#" target="_blank" className="ds"><FaLinkedinIn className="socalmedia-icon" /></a>
                                                    <a href="#" target="_blank" className="ds"><BsGithub className="socalmedia-icon" /></a>
